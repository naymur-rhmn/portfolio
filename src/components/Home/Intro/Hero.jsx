...
const Hero = () => {
  return (
    <section name="home" className="bg-bg1 overflow-hidden">
      <div className="max-w-screen-xl mx-auto px-8 md:py-0 pt-16 flex flex-col md:items-center md:flex-row gap-8 min-h-[calc(100vh-68px)] md:min-h-[calc(100vh-78px)] ">
        <div className="md:w-3/5 flex flex-col gap-8 ">
          <div className="flex flex-col gap-1">
            ...
            <h1 className="text-2xl md:text-4xl font-bold">A Web Developer.</h1>
          </div>
          ...
          <div className="flex gap-4">
            <Link to="contact" smooth={true} offset={-60} duration={500}>
              <button
                type="button"
                className="text-white bg-[#2d3645] border border-[#55666e] hover:bg-[#374151]  font-medium rounded-full text-sm lg:px-7 px-5 py-2.5 lg:py-4"
              >
                Contact with me
              </button>
            </Link>
